...
\begin{document}
	...
	Some dimensions, such as \textit{Tyre Context} and \textit{Weather Context}, are created by
	...
	\textit{Weather Context} describes the environmental condition.
	...
	\begin{longtable}{|p{3.5cm}|p{6cm}|p{7.5cm}|}
		\hline
		\textbf{Dimension} & \textbf{Attributes} & \textbf{Motivation} \\
		\hline
		\endfirsthead
