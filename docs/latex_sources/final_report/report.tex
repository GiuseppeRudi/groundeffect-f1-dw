...
\newcommand{\customtitle}{%
	\begin{center}
		...
		{\large A Data Warehouse for Formula One Performance Analysis\par}
...
\begin{document}
	...
	This comparison is particularly meaningful because the 2022 season introduced a new technical framework centred on ground-effect aerodynamics, which led to a substantial shift in car design philosophy.
	...
	For readability, Figure~\ref{fig:integrated-star-schema} presents a simplified logical star schema showing only table names. The complete star schema diagrams with all attributes are reported in Appendix~\ref{appendix:star-schema-details}.
	...
	\vspace{2em}
	This appendix section can be used to report full-size versions of the star schema diagrams.
