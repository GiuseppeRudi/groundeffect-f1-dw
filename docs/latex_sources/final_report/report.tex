...
\begin{document}
	...
	The Data Quality Assessment phase also produces visual outputs that summarize the main evidence generated by the scripts. 
	These plots are not part of the cleaning phase: they are used to document the detected issues and to support the following cleaning decisions.
	
	\begin{figure}[H]
		\centering
		\begin{subfigure}{0.32\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/dq_score_by_table.pdf}
			\caption{Score by table}
			\label{fig:dq-score-by-table}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.32\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/dq_score_by_dimension.pdf}
			\caption{Score by dimension}
			\label{fig:dq-score-by-dimension}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.32\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/dq_heatmap.pdf}
			\caption{Table-dimension heatmap}
			\label{fig:dq-heatmap}
		\end{subfigure}
		
		\caption{Visual summary of the General Data Quality Assessment.}
		\label{fig:general-dqa-visual-summary}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{0.48\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/missing_class_distribution.pdf}
		...
		\begin{subfigure}{0.48\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/missing_information_area.pdf}
			\caption{Missing information areas}
			\label{fig:missing-information-area}
		\end{subfigure}
		
		\caption{Visual summary of the focused missing-value interpretation.}
		\label{fig:missing-values-visual-summary}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{0.48\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/outlier_consensus_score.pdf}
			\caption{Consensus score distribution}
			\label{fig:outlier-consensus-score}
		\end{subfigure}
		\hfill
		\begin{subfigure}{0.48\linewidth}
			\centering
			\includegraphics[width=\linewidth]{figures/outlier_by_metric.pdf}
			\caption{Outliers by metric}
			\label{fig:outlier-by-metric}
		\end{subfigure}
		
		\caption{Visual summary of the focused outlier detection.}
		\label{fig:outlier-visual-summary}
	\end{figure}
