...
\begin{document}
	...
	For the \texttt{lap} table, the cleaning script creates a set of boolean quality
	flags.
	...
	\begin{longtable}{p{6cm}p{4cm}p{5cm}}
		...
		\texttt{has\_track\_status\_information\_issue}
	...
	For the \texttt{result} table, the same principle is used.
	...
	\begin{longtable}{p{5cm}p{5cm}p{5cm}}
		...
		\texttt{has\_qualifying\_information\_issue}
